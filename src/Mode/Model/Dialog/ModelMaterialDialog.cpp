	...
	CHuiWindow("dummy", -1, -1, 300, 300, _parent, _allow_parent, HuiWinModeControls | HuiWinModeResizable, true)
{
	...
	EventM("cancel", this, &ModelMaterialDialog::OnClose);
	EventM("hui:close", this, &ModelMaterialDialog::OnClose);
	EventM("apply", this, &ModelMaterialDialog::ApplyData);
	EventM("ok", this, &ModelMaterialDialog::OnOk);
	EventM("transparency_mode:material", this, &ModelMaterialDialog::OnTransparencyMode);
	EventM("transparency_mode:none", this, &ModelMaterialDialog::OnTransparencyMode);
	EventM("transparency_mode:function", this, &ModelMaterialDialog::OnTransparencyMode);
	EventM("transparency_mode:color_key", this, &ModelMaterialDialog::OnTransparencyMode);
	EventM("transparency_mode:factor", this, &ModelMaterialDialog::OnTransparencyMode);
	EventM("mat_add_texture_level", this, &ModelMaterialDialog::OnMatAddTextureLevel);
	EventMX("mat_textures", "hui:activate", this, &ModelMaterialDialog::OnMatTextures);
	EventMX("mat_textures", "hui:select", this, &ModelMaterialDialog::OnMatTexturesSelect);
	EventM("mat_delete_texture_level", this, &ModelMaterialDialog::OnMatDeleteTextureLevel);
	EventM("mat_empty_texture_level", this, &ModelMaterialDialog::OnMatEmptyTextureLevel);
	EventM("default_material", this, &ModelMaterialDialog::OnDefaultMaterial);
	EventM("find_material", this, &ModelMaterialDialog::OnFindMaterial);

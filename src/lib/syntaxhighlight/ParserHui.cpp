...
ParserHui::ParserHui() : Parser("Hui") {
	...
	keywords.add("fillv");
	keywords.add("shrink");
	keywords.add("shrinkx");
	keywords.add("shrinky");
	keywords.add("bold");
	keywords.add("italic");
	...
	keywords.add("range");
	keywords.add("margin");
	keywords.add("marginx");
	keywords.add("marginy");
	keywords.add("marginh");
	keywords.add("marginv");
	keywords.add("marginleft");
	keywords.add("marginright");
	keywords.add("margintop");
	keywords.add("marginbottom");
	keywords.add("padding");
	keywords.add("paddingx");
	keywords.add("paddingy");
	keywords.add("paddingv");
	keywords.add("paddingh");

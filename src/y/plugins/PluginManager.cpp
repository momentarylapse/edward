...
void import_kaba() {
	auto m_model = kaba::default_context->_load_module_throw("yengine/model.kaba", false);
	...
	auto m_world = kaba::default_context->_load_module_throw("yengine/world.kaba", false);
...
//	import_component_class<Terrain>(m_world, "Terrain");
	...
	auto m_fx = kaba::default_context->_load_module_throw("yengine/fx.kaba", false);
	...
	auto m_audio = kaba::default_context->_load_module_throw("yengine/audio.kaba", false);
	...
	auto m_net = kaba::default_context->_load_module_throw("yengine/networking.kaba", false);
	import_component_class<NetworkManager>(m_net, "NetworkManager", "ecs.System");

	auto m_y = kaba::default_context->_load_module_throw("yengine/yengine.kaba", false);
